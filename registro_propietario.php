...
<script>
    function enviar(op)
    {
        ...
        if (npropiedad === "") camposVacios.push("Número de Propiedad");
...
<body>
    ...
    <div id="formulario">
        <div class="card">
            <div class="card-header-c"><center><b>Formulario registro</b> <br><b>de</b><br> <b>Propietario</b></center></div>
            <div class="card-body">
                <form action="ingreso_propietario.php" name="formulario" method="post">
                        <div class="campos">
                            <div class="row">
