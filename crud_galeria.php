...
<body>
    ...
    <main class="main">
        ...
        <div class="botones-panel">
            <a href= "dashboard2.php" class="boton-icono">
                    ...
                    <div class="modal-body">
                        <form id="formPropiedad">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 campos-construccion">
    ...
    <script>
        ...
        function mostrarCamposSegunTipo() {
            ...
            // Para otros tipos como 'casa', no se oculta nada de forma predeterminada aquí.
        }
    ...
    <script>
        ...
        // Modificar la función guardarPropiedad para incluir imágenes
        const btnGuardar = document.querySelector('button.btn-primary[onclick="guardarPropiedad()"]');
        ...
        async function guardarPropiedad() {
            ...
            try {
                const response = await fetch('procesa_propiedades.php', {
                    method: 'POST',
                    body: formData
                });
